...
namespace OA_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //.net core >= 3.1 Added By Default
            //services.AddMemoryCache();

            //another custom cache service with no size limit (cause the entity freamework proxies service add 1024 size limit to built in IMemoryCache service)
            services.AddSingleton<ULMemoryCacheService>();

            #endregion

            #region "SMS Bulks"

            var SMSBulks = new List<SMSBulk>();
            Configuration.Bind(key: "SMSBulks", SMSBulks);
            services.AddSingleton(SMSBulks);
            ...
            //services.AddScoped<ISeedTestDataService, SeedTestDataService>();
